# Full copy of redata.dev

## XML Parser

**SmartXML** is a NoCode solution for parsing XML files with a wide range of features.
...
*   Generate SQL/JSON from XML and load them into the database, preserving hierarchical relationships
